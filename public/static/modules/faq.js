  ...
  <div class="fade-in max-w-3xl mx-auto">
    ...
    <div class="space-y-4">
      ...
      <div class="bg-white rounded-xl shadow-sm border p-5">
        ...
        <strong>Дискуссии</strong> → создаётся комната с датой и временем. Участники подключаются через видеозвонок на meet.re-search.wiki прямо на сайте. Есть чат, заметки, задачи.<br>
      ...
      <div class="bg-white rounded-xl shadow-sm border p-5">
        ...
        <strong>Member</strong> — авторизованный участник ячейки: добавляет материалы, участвует в дискуссиях.<br>
        <strong>Admin</strong> — полный доступ к системе, управление темами и участниками.</p>
      </div>
